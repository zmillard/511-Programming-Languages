...
#define SpinVersion	"Spin Version 6.4.7 -- 16 July 2017"
#define PanSource	"dkr_lea_a.pml"
...
#define _nstates2	7	/* p1 */
#define minseq2	80
#define maxseq2	85
#define _endstate2	6

#define _nstates1	34	/* :init: */
#define minseq1	47
#define maxseq1	79
#define _endstate1	33

#define _nstates0	48	/* nnode */
#define minseq0	0
#define maxseq0	46
...
#define Air1	(sizeof(P1) - Offsetof(P1, Ini) - 6*sizeof(uchar))

#define Pnnode	((P0 *)this)
typedef struct P0 { /* nnode */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
